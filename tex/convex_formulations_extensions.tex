...
\end{corollary}
\begin{proof}
In the current setting, $\lambda \ge 0$ since all generating units have non-negative marginal costs. Furthermore, $\eta_k \ge 0$, $\vartheta_k \ge 0$ and $e^\top \Sigma e > 0$ (as $\Sigma \succ 0$). It follows that $\alpha_k^\top \chi \ge 0$.
\end{proof}
