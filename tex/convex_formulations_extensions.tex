...
(Sensitivity to Mean Forecast Error) The expected system cost increases with the negative electricity price, that is,
\begin{equation*}
...
\end{equation*}
It is clear from the stationarity of Lagrangian with respect to $p_k$ that the term in parentheses is equal to $-\lambda^*$. We therefore have
\begin{align*}
