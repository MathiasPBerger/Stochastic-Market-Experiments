...
\begin{definition}
(Competitive Equilibrium) A competitive equilibrium for the stochastic market is a set prices $\{\lambda^*, \chi^*\}$ and decisions $\{p_k^*, \alpha_k^*\}_{\forall k}$ that\vspace{-5pt}
\begin{enumerate}
